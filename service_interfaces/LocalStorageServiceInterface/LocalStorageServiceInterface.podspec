#
#  Be sure to run `pod spec lint LocalStorageServiceInterface.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name                  = "LocalStorageServiceInterface"
  spec.version               = "0.0.1"
  spec.summary               = "A short description of LocalStorageServiceInterface."
  ...
  spec.dependency 'LocalStorageService'

  spec.resource_bundles = {
    'LocalStorageServiceInterfaceResources' => [
