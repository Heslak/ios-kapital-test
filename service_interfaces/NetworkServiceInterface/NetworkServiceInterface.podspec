#
#  Be sure to run `pod spec lint NetworkServiceInterface.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name                  = "NetworkServiceInterface"
  spec.version               = "0.0.1"
  spec.summary               = "A short description of NetworkServiceInterface."
  ...
  spec.resource_bundles = {
    'NetworkServiceInterfaceResources' => [
